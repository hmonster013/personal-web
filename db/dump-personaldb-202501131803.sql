...
-- Started on 2025-01-13 18:03:12
...
--
-- TOC entry 4683 (class 2604 OID 16794)
...
--
-- TOC entry 4684 (class 2604 OID 16803)
...
--
-- TOC entry 4678 (class 2604 OID 16727)
...
--
-- TOC entry 4679 (class 2604 OID 16728)
...
--
-- TOC entry 4680 (class 2604 OID 16729)
...
--
-- TOC entry 4681 (class 2604 OID 16730)
...
--
-- TOC entry 4682 (class 2604 OID 16731)
...
--
-- TOC entry 4875 (class 0 OID 16791)
-- Dependencies: 231
-- Data for Name: blogs; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.blogs VALUES (2, 'PySparkCode #1: Using Datetime functions', 'Datetime functions are essential when working with time-sensitive data, espectially in scenarios where data processing requires precise filtering or transformations based on dates and times.In this post, We’ll explore how to use PySpark’s datetime functions to solve a real-world problem: Detecting invalid transactions.Problem StatementImagine you have a dataset containing transactions for the month of Septemper, with the following columns: transaction_id and created_at (the timestamp of when the transaction was created).Your task is to filter out invalid transactions based on the following criteria:Transactions that occur outside of business hours (09:00-16:00, Monday-Friday).Transactions that take place on weekends (Saturday or Sunday).Transactions that occur on Vietnam’s public holiday, specifically the 2nd of September.', 'Getting started with applying datetime functions to dataframe in PySpark.', 'ACTIVE', '2003-05-18 00:00:00', '2003-05-19 00:00:00', 'http://localhost:8081/v1/image/view/01223d94-f7c5-4641-8bed-35bb0736efe9_pyspark-datetime.DWdSGHu8_2nrq9c.webp');


--
-- TOC entry 4877 (class 0 OID 16800)
-- Dependencies: 233
-- Data for Name: blogs_skills; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.blogs_skills VALUES (3, 2, 61);
INSERT INTO public.blogs_skills VALUES (4, 2, 62);


--
-- TOC entry 4859 (class 0 OID 16687)
-- Dependencies: 215
...
--
-- TOC entry 4863 (class 0 OID 16699)
-- Dependencies: 219
...
--
-- TOC entry 4865 (class 0 OID 16705)
-- Dependencies: 221
...
--
-- TOC entry 4867 (class 0 OID 16709)
-- Dependencies: 223
...
--
-- TOC entry 4869 (class 0 OID 16714)
-- Dependencies: 225
...
--
-- TOC entry 4871 (class 0 OID 16720)
-- Dependencies: 227
...
--
-- TOC entry 4873 (class 0 OID 16724)
-- Dependencies: 229
...
SELECT pg_catalog.setval('public.blogs_skills_id_seq', 4, true);
...
--
-- TOC entry 4707 (class 2606 OID 16798)
...
--
-- TOC entry 4709 (class 2606 OID 16805)
...
--
-- TOC entry 4689 (class 2606 OID 16743)
...
--
-- TOC entry 4691 (class 2606 OID 16745)
...
--
-- TOC entry 4693 (class 2606 OID 16747)
...
--
-- TOC entry 4695 (class 2606 OID 16749)
...
--
-- TOC entry 4697 (class 2606 OID 16751)
...
--
-- TOC entry 4699 (class 2606 OID 16753)
...
--
-- TOC entry 4701 (class 2606 OID 16755)
...
--
-- TOC entry 4703 (class 2606 OID 16757)
...
--
-- TOC entry 4705 (class 2606 OID 16759)
...
--
-- TOC entry 4714 (class 2606 OID 16806)
...
--
-- TOC entry 4715 (class 2606 OID 16811)
...
--
-- TOC entry 4712 (class 2606 OID 16760)
...
--
-- TOC entry 4713 (class 2606 OID 16765)
...
--
-- TOC entry 4711 (class 2606 OID 16775)
...
-- Completed on 2025-01-13 18:03:12
